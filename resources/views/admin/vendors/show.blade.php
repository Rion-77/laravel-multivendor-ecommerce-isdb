                    ...
                    <div class="col-lg-4">
                        <div class="card card-primary card-outline">
                            <div class="card-body text-center">
                                ...
                                @else
                                    <img src="https://picsum.photos/300/{{ $vendor->id + 300 }}" alt=""
                                        class="rounded-circle shadow" style="width:100px;height:100px;object-fit:cover;">
                                @endif

                                <h3 class="mt-3 mb-0">{{ $vendor->shop_name }}</h3>
                                {{-- <p class="text-secondary mb-2">marthub.com/nova-electronics</p> --}}
                                <span class="badge text-bg-success mb-3"><i class="bi bi-patch-check-fill me-1"></i>Verified
                                    Vendor</span>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('admin.vendors.edit', ['vendor' => $vendor->id]) }}"
                                        class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil me-1"></i>Edit</a>
                    ...
                    <div class="col-lg-8">
                        {{-- <div class="row mb-3 g-3">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="card text-center">
                                    <div class="card-body py-3">
                                        <div class="fs-4 fw-semibold">4.6<i
                                                class="bi bi-star-fill text-warning ms-1 fs-7"></i></div>
                            ...
                            <div class="card-header p-0 border-bottom-0">
                                <ul class="nav nav-tabs" id="vendor-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="tab-products-btn" data-bs-toggle="tab"
                                            data-bs-target="#tab-products" type="button" role="tab"
                                            aria-selected="true">Products</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="tab-orders-btn" data-bs-toggle="tab"
                                            data-bs-target="#tab-orders" type="button" role="tab" aria-selected="false"
                                            tabindex="-1">Recent Orders</button>
                                    </li>
                                    {{-- <li class="nav-item" role="presentation">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="tab-products" role="tabpanel"
                                        aria-labelledby="tab-products-btn">
                                        <div class="row g-3">
                                            @foreach ($products as $product)
                                                <div class="col-6 col-md-4">
                                                    <div class="card h-100">
                                                        ...
                                                        @else
                                                            <img src="https://picsum.photos/300/{{ $product->id + 300 }}"
                                                                    class="card-img-top" style="height:120px;object-fit:cover;">
                                                            
                                                        @endif

                                                        <div class="card-body p-2">
                                                            <div class="fs-7 fw-medium text-truncate">{{ $product->name }}
                                                            </div>
                                                            <div class="text-secondary fs-7">Price:
                                                                ${{ number_format($product->base_price) }}</div>
                                                            <div class="text-secondary fs-7">Offer Price:
                                                                ${{ number_format($product->offer_price) }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        {{-- <a href="./products-list.html" class="btn btn-sm btn-outline-secondary mt-3">View
                                            all products</a> --}}
                                    </div>

                                    <div class="tab-pane fade" id="tab-orders" role="tabpanel"
                                        aria-labelledby="tab-orders-btn">
                                        ...
                                        <a href="./orders-list.html" class="btn btn-sm btn-outline-secondary">View all
                                            orders</a>
                                    </div>
                                    ...
                                    {{-- <div class="tab-pane fade" id="tab-reviews" role="tabpanel"
                                        ...
                                        <article class="d-flex gap-3 mb-4">
                                            <img src="{{ asset('img/user4-128x128.jpg') }}" class="rounded-circle"
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 text-secondary fs-7">Fast shipping and the earbuds sound
                                                    amazing. Will order again.</p>
                                            </div>
                                        </article>
                                        <article class="d-flex gap-3">
                                            <img src="{{ asset('img/user5-128x128.jpg') }}" class="rounded-circle"
                                                style="width:40px;height:40px;object-fit:cover;" alt="">
                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between">
                                                ...
                                                <p class="mb-0 text-secondary fs-7">Good product, packaging could be
                                                    better.</p>
                                            </div>
                                        </article>
                                        <a href="./reviews.html" class="btn btn-sm btn-outline-secondary mt-3">View all
                                            reviews</a>
                                    </div> --}}
                                </div>
                            </div>
